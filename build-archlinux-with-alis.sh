...
echo
	...
	buildFolder=$HOME"/arco/AA-build"
	outFolder=$HOME"/arco/AA-Out"
...
echo
	...
	git clone https://github.com/tenchapmans/alis $buildFolder/archiso/airootfs/alis
	mkdir $buildFolder/archiso/airootfs/alis-dev
	git clone https://github.com/tenchapmans/alis-dev $buildFolder/archiso/airootfs/alis-dev
